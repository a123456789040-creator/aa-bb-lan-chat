# OpenAI Codex for OSS Submission Draft

This file is written to be pasted directly into the `Codex for Open Source` application after the GitHub repository is public.

## Suggested submission status

This project is still early-stage. The strongest path is:

1. Publish the repository first
2. Add at least a few visible follow-up commits after publication
3. Then submit this application text

You can still apply immediately, but the project will read as a new open-source repository rather than an established ecosystem dependency.

## Field: Which open source project are you representing?

AA BB LAN Chat

## Field: Brief description of the project
...
Paste your public GitHub repository URL here after publishing.
...
## Field: How would you use API credits for your project?
...
## Field: Is there anything else you'd like us to know?
...
If you want a more compact submission, use this:

### Brief description

AA BB LAN Chat is a lightweight open-source LAN chat application built with Node.js, Express, and Socket.IO. It provides real-time coordination for three fixed participants on the same trusted local network, with role claiming, presence updates, typing indicators, LAN address discovery, and helper scripts for smoke testing and scripted messaging. The project is intentionally compact and easy to inspect, making it useful both as a practical local tool and as a reference implementation for small realtime collaboration apps.

### API credits

I would use API credits to support maintainer workflows for this project, including issue triage, documentation updates, code review assistance, regression checks, and contributor onboarding. I am particularly interested in evaluating whether Codex can help maintain a small realtime codebase effectively while keeping the project easy to understand and extend.
